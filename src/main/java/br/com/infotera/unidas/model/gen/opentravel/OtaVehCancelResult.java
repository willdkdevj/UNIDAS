...
@XmlType(name = "", propOrder = {
    "errorsOrSuccessOrVehCancelRSCore"
})
@XmlRootElement(name = "OtaVehCancelResult")
public class OtaVehCancelResult {

    @XmlElements({
        @XmlElement(name = "Errors", type = ErrorsType.class),
        @XmlElement(name = "Success", type = SuccessType.class),
        @XmlElement(name = "VehCancelRSCore", type = OtaVehCancelResult.VehCancelRSCore.class),
        @XmlElement(name = "VehCancelRSInfo", type = VehicleCancelRSAdditionalInfoType.class),
        @XmlElement(name = "Warnings", type = WarningsType.class)
    })
    protected List<Object> errorsOrSuccessOrVehCancelRSCore;
    ...
    /**
     * Gets the value of the errorsOrSuccessOrVehCancelRSCore property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the errorsOrSuccessOrVehCancelRSCore property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getErrorsOrSuccessOrVehCancelRSCore().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * {@link ErrorsType }
     * {@link SuccessType }
     * {@link OtaVehCancelResult.VehCancelRSCore }
     * {@link VehicleCancelRSAdditionalInfoType }
     * {@link WarningsType }
     * 
     * 
     */
    public List<Object> getErrorsOrSuccessOrVehCancelRSCore() {
        if (errorsOrSuccessOrVehCancelRSCore == null) {
            errorsOrSuccessOrVehCancelRSCore = new ArrayList<Object>();
        }
        return this.errorsOrSuccessOrVehCancelRSCore;
    }
        ...
        extends CancelInfoRSType
    {
        ...
        /**
         * Obtém o valor da propriedade cancelStatus.
         * 
         * @return
         *     possible object is
        ...
        /**
         * Define o valor da propriedade cancelStatus.
         * 
         * @param value
         *     allowed object is
         *     {@link TransactionStatusType }
