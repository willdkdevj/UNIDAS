...
/**
 * <p>Classe Java de VehicleModifyRQAdditionalInfoType complex type.
 * 
...
@XmlSeeAlso({
    br.com.infotera.unidas.model.gen.opentravel.OTAVehModifyRQ.VehModifyRQInfo.class
})
public class VehicleModifyRQAdditionalInfoType {
    ...
    /**
     * Obtém o valor da propriedade writtenConfInst.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define o valor da propriedade writtenConfInst.
     * 
     * @param value
     *     allowed object is
     *     {@link WrittenConfInstType }
