...
@XmlType(name = "", propOrder = {
    "additionalFeesOrDateOrErrors"
})
@XmlRootElement(name = "OtaVehLocDetailResult")
public class OtaVehLocDetailResult {

    @XmlElements({
        @XmlElement(name = "AdditionalFees", type = VehicleLocationAdditionalFeesType.class),
        @XmlElement(name = "Date", type = OtaVehLocDetailResult.Date.class),
        @XmlElement(name = "Errors", type = ErrorsType.class),
        @XmlElement(name = "Liabilities", type = VehicleLocationLiabilitiesType.class),
        @XmlElement(name = "LocationDetail", type = VehicleLocationDetailsType.class),
        @XmlElement(name = "Requirements", type = VehicleLocationRequirementsType.class),
        @XmlElement(name = "ServicesOffered", type = VehicleLocationServicesOfferedType.class),
        @XmlElement(name = "Success", type = SuccessType.class),
        @XmlElement(name = "TPA_Extensions", type = TPAExtensionsType.class),
        @XmlElement(name = "Vehicles", type = VehicleLocationVehiclesType.class),
        @XmlElement(name = "Vendor", type = CompanyNameType.class),
        @XmlElement(name = "Warnings", type = WarningsType.class)
    })
    protected List<Object> additionalFeesOrDateOrErrors;
    ...
    /**
     * Gets the value of the additionalFeesOrDateOrErrors property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the additionalFeesOrDateOrErrors property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAdditionalFeesOrDateOrErrors().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * {@link OtaVehLocDetailResult.Date }
     * {@link ErrorsType }
     ...
     * 
     */
    public List<Object> getAdditionalFeesOrDateOrErrors() {
        if (additionalFeesOrDateOrErrors == null) {
            additionalFeesOrDateOrErrors = new ArrayList<Object>();
        }
        return this.additionalFeesOrDateOrErrors;
    }
