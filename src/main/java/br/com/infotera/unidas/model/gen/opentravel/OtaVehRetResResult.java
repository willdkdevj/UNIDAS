...
@XmlType(name = "", propOrder = {
    "errorsOrSuccessOrVehRetResRSCore"
})
@XmlRootElement(name = "OtaVehRetResResult")
public class OtaVehRetResResult {

    @XmlElements({
        @XmlElement(name = "Errors", type = ErrorsType.class),
        @XmlElement(name = "Success", type = SuccessType.class),
        @XmlElement(name = "VehRetResRSCore", type = VehicleRetrieveResRSCoreType.class),
        @XmlElement(name = "VehRetResRSInfo", type = VehicleRetrieveResRSAdditionalInfoType.class),
        @XmlElement(name = "Warnings", type = WarningsType.class)
    })
    protected List<Object> errorsOrSuccessOrVehRetResRSCore;
    ...
    /**
     * Gets the value of the errorsOrSuccessOrVehRetResRSCore property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the errorsOrSuccessOrVehRetResRSCore property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getErrorsOrSuccessOrVehRetResRSCore().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getErrorsOrSuccessOrVehRetResRSCore() {
        if (errorsOrSuccessOrVehRetResRSCore == null) {
            errorsOrSuccessOrVehRetResRSCore = new ArrayList<Object>();
        }
        return this.errorsOrSuccessOrVehRetResRSCore;
    }
