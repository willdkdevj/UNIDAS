 ...
 *           &lt;element name="VehMatchedLocs" minOccurs="0"&gt;
 *             &lt;complexType&gt;
 *               &lt;complexContent&gt;
 *                 &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                   &lt;sequence&gt;
...
@XmlType(name = "", propOrder = {
    "errorsOrSuccessOrTPAExtensions"
})
@XmlRootElement(name = "OtaVehLocSearchResult")
public class OtaVehLocSearchResult {

    @XmlElements({
        @XmlElement(name = "Errors", type = ErrorsType.class),
        @XmlElement(name = "Success", type = SuccessType.class),
        @XmlElement(name = "TPA_Extensions", type = TPAExtensionsType.class),
        @XmlElement(name = "VehMatchedLocs", type = OtaVehLocSearchResult.VehMatchedLocs.class),
        @XmlElement(name = "Vendor", type = CompanyNameType.class),
        @XmlElement(name = "Warnings", type = WarningsType.class)
    })
    protected List<Object> errorsOrSuccessOrTPAExtensions;
    ...
    /**
     * Gets the value of the errorsOrSuccessOrTPAExtensions property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the errorsOrSuccessOrTPAExtensions property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getErrorsOrSuccessOrTPAExtensions().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * {@link OtaVehLocSearchResult.VehMatchedLocs }
     * {@link CompanyNameType }
     * {@link WarningsType }
     * 
     * 
     */
    public List<Object> getErrorsOrSuccessOrTPAExtensions() {
        if (errorsOrSuccessOrTPAExtensions == null) {
            errorsOrSuccessOrTPAExtensions = new ArrayList<Object>();
        }
        return this.errorsOrSuccessOrTPAExtensions;
    }
